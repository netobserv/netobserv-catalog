...
Some of the commands below require an access to `registry.redhat.io`. Make sure you have it (e.g. by running `export REGISTRY_AUTH_FILE=/path/to/secret.json` first).
